...
class IcebergParser(object):
    ...
    def __init__(self):
        parser = argparse.ArgumentParser(description='ICEBERG command description:',
            usage='''iceberg <resource> <queue> <cpus> <gpus> <input path> <output path> <wall time> <use case> [<args>]
             ''')
        parser.add_argument('resource', help='Where the execution will happen')
        parser.add_argument('queue', help='The queue of the resource')
        parser.add_argument('cpus', help='How many CPUs will be required')
        parser.add_argument('gpus', help='How many GPUs will be required')
        parser.add_argument('input_path', help='Where the input images are')
        parser.add_argument('output_path', help='Where the results should be saved')
        parser.add_argument('walltime', help='The estimated execution time')
        parser.add_argument('usecase', help='The type of analysis to be executed')
